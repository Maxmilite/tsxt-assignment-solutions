...
// ----------------------------------------------------------------------------------------
    ...
    {
        // Target: SLOW
        // std::cerr << std::fixed << std::setprecision(5) << "Load Start" << ": " << std::chrono::system_clock::now().time_since_epoch().count() * 1.0 * std::chrono::system_clock::period::num / std::chrono::system_clock::period::den << std::endl;
        scanner.load(img);
        // std::cerr << std::fixed << std::setprecision(5) << "Load End" << ": " << std::chrono::system_clock::now().time_since_epoch().count() * 1.0 * std::chrono::system_clock::period::num / std::chrono::system_clock::period::den << std::endl;
